...
class Training_Avatarcustomer_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    /**
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                /** We add media/customer for url in image */
                $newUrlPath = Mage::helper('training_avatarcustomer')->getAdminPicUrl($customer->getData('avatar'));

                $customer->setData('avatar', $newUrlPath);
