...
class School_OnlineGaming_Block_Adminhtml_Gamesgrid_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('onlinegaming_gamesgrid')->getId()) {
            return Mage::helper('adminhtml')->__("Edit Block '%s'", $this->escapeHtml(Mage::registry('onlinegaming_gamesgrid')->getTitle()));
        }
        else {
